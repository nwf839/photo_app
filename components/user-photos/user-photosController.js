...
cs142App.controller('UserPhotosController', ['$scope', '$stateParams', 'UserPhotosService', 'AddCommentService', 'Session',
  function($scope, $stateParams, UserPhotosService, AddCommentService, Session) {
    /*
